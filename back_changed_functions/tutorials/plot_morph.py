...
# precomputed but instead will be prepared for morphing when calling. This
# works only with (Vector) :class:`SourceEstimate <mne.SourceEstimate>`.
# See :class:`mne.SourceMorph` for additional parameter settings.
...
# can be initialized taking only src as argument (for better understanding more
# keyword arguments are defined). See :class:`mne.SourceMorph` for additional
# parameter settings.
